...
\author[Miguel A. Nunes]{Miguel Alfredo Nunes, Jeferson L. R. Souza, Claudio Cesar de Sá
\\\medskip 
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    %\begin{itemize}
    %\item {\small \url{joaobattisti@gmail.com}}
    %\end{itemize}

    \item Paulo Victor de Aguiar;
    %\begin{itemize}
    %\item {\small \url{pavaguiar@gmail.com}}
    %\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{aulas_udemy_picat}
\include{introducao_picat}
\include{tipos_dados_variaveis_picat}
\include{predicados_funcoes_picat}
\include{recursao_picat}
%\include{listas_picat} % cap 4 nesse capitulo falar mais de listas
%\include{funcoes_picat} % cap 5 finalizar aqui
\include{buscas_picat}
\include{conclusoes_picat}
\end{document}
