...
\include{introducao_picat} %1
\include{tipos_dados_variaveis_picat} %2
\include{regras_picat} %3
\include{estruturas_decisao_repeticao} %3
\include{recursao_picat} %4
\include{listas_picat} %5
\include{buscas_picat} %6
\include{PD_picat} %7
\include{planejamento_picat} %8
\include{CP_picat} %9
\include{conclusoes_picat} %10
\end{document}
