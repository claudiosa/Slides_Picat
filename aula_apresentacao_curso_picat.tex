...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \end{itemize}
			...
			\item Além do material aqui disponível em PDF, o mais importante  do curso vai estar na interatividade
			da minha \textbf{apresentação oral}. 
			
			\item Ou seja, este material é  um guia para o seu desenvolvimento, mas minhas explicações são
