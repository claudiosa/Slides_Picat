...
\begin{frame}[fragile] 
    ...
    \begin{itemize}
      ...
      sempre acusa warnings etc. O modo compilado na console, não.
      ...
      detectada.
       ...
       \pause
      \item Consulte o manual do usuário \textit{on-line} em \textit{html}, mantido pelo Alexandre Gonçalves, UFSC
